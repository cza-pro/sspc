...
<template>
  ...
  <div class="filter-block">
    <div class="filter-left">
      ...
      <div class="subject-btns">
        <p class="each-btn" :class="topic.available === 'off' ? 'removeitem' : ''" v-for="(topic) in props.topics" :key="topic.id">{{topic.name}}</p>
      </div>
    </div>
  ...
  <div v-if="addNewLabel" class="modal">
    <div class="modal-newgrade-content">
      ...
      <div class="file-div">
        <input type="text" v-model="addForm.name" id="newGrade" name="newGrade" class="gradecss" placeholder="Topic Name">
      </div>
        <InputError :message="addForm.errors.name"/>
      <div class="btn-btn">
        <p class="grade-btn" @click="addTopic">確認新增</p>
      </div>
    </div>
  </div>
